...
dotnet format style . --severity info --no-restore --verbosity normal "${EXCLUDE_ARGS[@]}"
dotnet format analyzers . --severity info --no-restore --verbosity normal "${EXCLUDE_ARGS[@]}"
dotnet format whitespace . --no-restore --verbosity normal "${EXCLUDE_ARGS[@]}"
