...
namespace UmbracoHeadlessBFF.Cms.Modules.Common.Umbraco.Overrides.RichText;
...
internal sealed class ApiRichTextElementParser : ApiRichTextParserBase, IApiRichTextElementParser
{
        ...
        where T : IRichTextElement
    {
        ...
        ReplaceLocalLinks(contentCache, mediaCache, element, attributes);
    ...
    private void ReplaceLocalLinks(IPublishedContentCache contentCache, IPublishedMediaCache mediaCache, HtmlNode link, Dictionary<string, object> attributes)
    {
